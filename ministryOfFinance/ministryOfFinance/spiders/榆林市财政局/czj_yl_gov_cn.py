...
# ===================== XPath 常量 =====================
LIST_XPATH = {
    'detail_urls': "//ul[@class='innerList']/li/a/@href",
    'publish_times': "//ul[@class='innerList']/li/span/text()",
...
class CzjYlGovCn(BasePortiaSpider):
    name = "czj_yl_gov_cn"
    allowed_domains = ["czj.yl.gov.cn"]

    start_urls = ['https://czj.yl.gov.cn/xwzx/czdt/']
