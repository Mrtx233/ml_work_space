...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjYulinGovCnSpider(BasePortiaSpider):
    name = "mzj_yulin_gov_cn"
    allowed_domains = ["mzj.yulin.gov.cn"]
    start_urls = [
        "http://mzj.yulin.gov.cn/zwdt/zwyw/",
        "http://mzj.yulin.gov.cn/ghjh/",
        "http://mzj.yulin.gov.cn/zcjd/",
        "http://mzj.yulin.gov.cn/zwdt/tzgg/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/ldfg/ldjj/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/ldfg/jggk/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/sjfb/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/rsxx/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/xzzf/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/qzqd/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/zfcg/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/czyjs/sgjf/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/czyjs/czys/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/czyjs/czjs/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/sgs/",
        "http://mzj.yulin.gov.cn/zwgk/fdzdgknr/shgysyjslygk/"
    ]
