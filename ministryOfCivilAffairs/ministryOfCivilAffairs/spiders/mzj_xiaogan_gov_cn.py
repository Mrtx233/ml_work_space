...
# 列表页XPath
LIST_XPATH = {
    "detail_urls": '//*[@id="newslist"]/li/a/@href | //*[@class="news-list"]/li/a/@href',  # 详情页链接
    "publish_times": '//*[@id="newslist"]/li/span/text() | //*[@class="news-list"]/li/span/text()',  # 发布时间
...
DETAIL_XPATH = {
    ...
    "content": '//div[contains(@class, "r-rest")]//p',  # 正文内容
    "attachment": '//div[contains(@class, "r-rest")]//p//a/@href',  # 附件链接
    "attachment_name": '//div[contains(@class, "r-rest")]//p//a/text()',  # 附件名称
...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjXiaoganGovCnSpider(BasePortiaSpider):
    name = "mzj_xiaogan_gov_cn"
    allowed_domains = ["mzj.xiaogan.gov.cn"]
    start_urls = [
        "https://mzj.xiaogan.gov.cn/zwdt/",
        "https://mzj.xiaogan.gov.cn/zwdt/xsqxx/",
        "https://mzj.xiaogan.gov.cn/zwdt/ssxw/",
        "https://mzj.xiaogan.gov.cn/zwdt/mtdt/",
        "https://mzj.xiaogan.gov.cn/zwdt/sqxzjcgszl/",
        "https://mzj.xiaogan.gov.cn/ywgz/",
        "https://mzj.xiaogan.gov.cn/ywgz/mzyw/",
        "https://mzj.xiaogan.gov.cn/ywgz/mzfc/",
        "https://mzj.xiaogan.gov.cn/ywgz/gzyj/",
        "https://mzj.xiaogan.gov.cn/gwfb/",
        "https://mzj.xiaogan.gov.cn/bsfw/",
        "https://mzj.xiaogan.gov.cn/zmhd/yjzj/",
        "https://mzj.xiaogan.gov.cn/zfxxgk/gsgg02/"
    ]
