...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjBaiseGovCnSpider(BasePortiaSpider):
    name = "mzj_baise_gov_cn"
    allowed_domains = ["mzj.baise.gov.cn"]
    start_urls = [
        "http://mzj.baise.gov.cn/gzdt/",
        "http://mzj.baise.gov.cn/zfyw/",
        "http://mzj.baise.gov.cn/zcwj/",
        "http://mzj.baise.gov.cn/tzgg/",
        "http://mzj.baise.gov.cn/dczj/",
        "http://mzj.baise.gov.cn/qlqd/",
        "http://mzj.baise.gov.cn/jggl/jgzyzz/",
        "http://mzj.baise.gov.cn/jggl/nsjgsz/"
    ]
