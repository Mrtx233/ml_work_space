...
# 列表页XPath
LIST_XPATH = {
    "detail_urls": '//div[@class="xiaright"]//ul//a/@href | //div[@class="zfxxgk_zdgkc"]//ul//a/@href',  # 详情页链接
    "publish_times": '//div[@class="xiaright"]//ul//span/text() | //div[@class="zfxxgk_zdgkc"]//ul//b/text()',  # 发布时间
...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjGuiyangGovCnSpider(BasePortiaSpider):
    name = "mzj_guiyang_gov_cn"
    allowed_domains = ["mzj.guiyang.gov.cn"]
    start_urls = [
        "https://mzj.guiyang.gov.cn/xxgk/mtgz/",
        "https://mzj.guiyang.gov.cn/xxgk/mtgzlm/",
        "https://mzj.guiyang.gov.cn/xxgk/gzdt/",
        "https://mzj.guiyang.gov.cn/xxgk/tzgg/",
        "https://mzj.guiyang.gov.cn/jdhy/zcjd/",
        "https://mzj.guiyang.gov.cn/jdhy/hygq/",
        "https://mzj.guiyang.gov.cn/zmhd/cjwt/",
        "https://mzj.guiyang.gov.cn/zmhd/yjzj/",
        "https://mzj.guiyang.gov.cn/xxgk/wjxgfz/",
        "https://mzj.guiyang.gov.cn/mzsj/zxtj/"
    ]
