...
# 列表页XPath
LIST_XPATH = {
    "detail_urls": '//*[@class="ul_list1 clearfix"]//li/a/@href',  # 详情页链接
    "publish_times": '//*[@class="ul_list1 clearfix"]//li/span/text()',  # 发布时间
...
DETAIL_XPATH = {
    ...
    "menu": '//div[@class="article_site clearfix"]//a/text()',  # 面包屑菜单
    "content": '//div[contains(@class, "p_box")]//p',  # 正文内容
    "attachment": '//div[contains(@class, "p_box")]//p//a/@href',  # 附件链接
    "attachment_name": '//div[contains(@class, "p_box")]//p//a/text()',  # 附件名称
...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class WwwHuaihuaGovCnSpider(BasePortiaSpider):
    name = "www_huaihua_gov_cn"
    allowed_domains = ["www.huaihua.gov.cn"]
    start_urls = [
        "https://www.huaihua.gov.cn/mzj/c108768/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108772/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108774/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108775/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108776/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108777/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c115922/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108789/list.shtml",
        "https://www.huaihua.gov.cn/mzj/c108805/list.shtml"

    ]

    def make_url_base(self, page: int, base_url: str) -> str:
        return f"{base_url.rstrip('list.shtml')}/list_{page + 2}.shtml"
