...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjWuzhouGovCnSpider(BasePortiaSpider):
    name = "mzj_wuzhou_gov_cn"
    allowed_domains = ["mzj.wuzhou.gov.cn"]
    start_urls = [
        "http://mzj.wuzhou.gov.cn/gzdt/",
        "http://mzj.wuzhou.gov.cn/tzgg/",
        "http://mzj.wuzhou.gov.cn/zfyw/",
        "http://mzj.wuzhou.gov.cn/jcxx/",
        "http://mzj.wuzhou.gov.cn/fzzfjs/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/txsxzd/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/ccfszqzsbdsfhfbwtzxgz/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/wzsdecqgdmzxpczl/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/ZFXS/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/bwcxljsm/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/gclssjjwzqhjs/",
        "http://mzj.wuzhou.gov.cn/tpzl/lszl/dsxxjy/",
        "http://mzj.wuzhou.gov.cn/tpzl/wcnrbhzl/",
        "http://mzj.wuzhou.gov.cn/tpzl/zdlyxxgkzl/",
        "http://mzj.wuzhou.gov.cn/tpzl/yasfzl/",
        "http://mzj.wuzhou.gov.cn/tpzl/jczqgkbzhgfh/",
        "http://mzj.wuzhou.gov.cn/qzqd/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/xzcf/xzcfxxgs/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/czysjsxx/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/xzsyxsf/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/gwyzl/sydwzp/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/zfcg/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/yjya/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/gysy/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/shjz/",
        "http://mzj.wuzhou.gov.cn/xxgk/fdzdgknr/rsxxlm/"
    ]
