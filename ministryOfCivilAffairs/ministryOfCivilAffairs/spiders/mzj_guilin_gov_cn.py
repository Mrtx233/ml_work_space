...
# 列表页XPath
LIST_XPATH = {
    "detail_urls": '//li[@class="clearfix"]//a/@href',  # 详情页链接
    "publish_times": '//li[@class="clearfix"]//a/span/text()',  # 发布时间
...
# ===================== 爬虫逻辑（仅引用变量，无其他修改） =====================
class MzjGuilinGovCnSpider(BasePortiaSpider):
    name = "mzj_guilin_gov_cn"
    allowed_domains = ["mzj.guilin.gov.cn"]
    start_urls = [
        "https://mzj.guilin.gov.cn/tzgg/",
        "https://mzj.guilin.gov.cn/gzdt/",
        "https://mzj.guilin.gov.cn/jcxx/",
        "https://mzj.guilin.gov.cn/zfwznb/",
